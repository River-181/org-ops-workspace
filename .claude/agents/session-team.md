...
- `_system/agents/memory/active-context.md` — 현재 세션 상태
- `_system/identity/workflow.md` — 세션 폴더 명명 규칙
- `02_sessions/{세션폴더}/plan.md` — 세션 기획안
- `05_library/research/README.md` — 리서치 산출물 유형
- `04_studio/brand/` — 브랜드 가이드 (슬라이드 제작 시)
