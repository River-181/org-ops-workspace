...
description: 세션 변경사항을 올바른 거버넌스 파일로 라우팅해 업데이트합니다. "메모리 업데이트", "거버넌스 갱신", "이 변경 기록해줘", "결정 기록해줘", "스킬 추가했어", "시스템 바꿨어" 등의 요청 시 사용. active-context / change-log / decisions / 클럽타임라인 / CLAUDE.md 중 적절한 곳을 자동 선택.
---

# Update Governance

[볼트명] 거버넌스 파일의 변경사항을 올바른 위치로 라우팅·기록하는 메타 스킬.
...
| 클럽 역사에 남길 마일스톤 | `01_ops/strategy/260314-클럽타임라인.md` | **append** |
...
이 변경을 다음 위치에 기록합니다:
  ...
  2. _system/agents/memory/decisions/260417-결정제목.md — [결정 요약]
진행? (y / 수정)
```
